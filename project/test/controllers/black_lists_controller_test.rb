...
class BlackListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create black_list" do
    assert_difference('BlackList.count') do
      post black_lists_url, params: { black_list: { post_id: @black_list.post_id, registred_user_id: @black_list.registred_user_id } }
    end
  ...
  test "should update black_list" do
    patch black_list_url(@black_list), params: { black_list: { post_id: @black_list.post_id, registred_user_id: @black_list.registred_user_id } }
