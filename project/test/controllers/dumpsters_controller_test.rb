...
class DumpstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dumpster" do
    assert_difference('Dumpster.count') do
      post dumpsters_url, params: { dumpster: { post_id: @dumpster.post_id, registred_user_id: @dumpster.registred_user_id } }
    end
  ...
  test "should update dumpster" do
    patch dumpster_url(@dumpster), params: { dumpster: { post_id: @dumpster.post_id, registred_user_id: @dumpster.registred_user_id } }
